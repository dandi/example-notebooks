...
## This directory a duplicate of the [DJ-NWB-Hires-Gutnisky-2015 repository](https://github.com/datajoint-company/DJ-NWB-Hires-Gutnisky-2015) as part of the [DataJoint NWB Showcase](https://github.com/datajoint-company/DataJoint-NWB-showcase).
